...
> **Y hay un caso que no delata ningún paquete sospechoso:** mientras la interfaz siga en DHCP, es
> el propio cliente quien reescribe `/etc/resolv.conf` en cada renovación del arrendamiento. Se
> reconoce por su primera línea:
>
> ```
